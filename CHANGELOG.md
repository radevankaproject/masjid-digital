...
### Diubah
- Mengoptimasi kode dengan membersihkan *duplicated query* (N+1 query problem) untuk performa yang lebih baik.
...
- Menambahkan *Additional Terms* pada lisensi untuk atribusi kepemilikan dan kolaborasi.
- Memperbarui `.gitignore` dengan pengecualian tambahan (`.rtk`, `CLAUDE.md`, dll).
- *Finishing touches* dan stabilisasi sistem.
